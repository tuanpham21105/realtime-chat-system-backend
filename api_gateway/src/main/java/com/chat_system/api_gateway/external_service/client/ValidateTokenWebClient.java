...
import com.chat_system.api_gateway.external_service.dto.ValidateAccessTokenResponseDto;
...
public class ValidateTokenWebClient {
    ...
    public Mono<ValidateAccessTokenResponseDto> validateAccessToken(String accessToken) {
